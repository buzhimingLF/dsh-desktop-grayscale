	...
	factory: (require) => {
		...
		*/
		function AquaAppearanceRow(props) {
			const { t, setMode, setBlur, setFrost, setFluidHue, setBgBrightness, setBackground, setWallpaper, setWhale, setCritters, setWallpaperBlur, setWallpaperFrost, useStore } = props;
			const enabled = useStore((s) => s.enabled);
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: AquaAppearanceRow_module_css_default.inlineLabel,
